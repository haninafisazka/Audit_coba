...
<div class="container-fluid">
    <div class="row mt-3">
        ...
        <div class="col">
            <h2 class="text-center">Rencana Tindak Lanjut Temuan</h2>
            <hr>
            <div class="card mb-3 p-2">
                <div class="tab-pane fade show active" id="format_soal" role="tabpanel" aria-labelledby="format_soal-tab">
                    <div class="card-body">
                        ...
                        <div class="col-auto mb-3">Rencana Tindak Lanjut :</div>
                                    ...
                                    <div class="col-auto mb-3">Tanggal Kesanggupan :</div>
                                    <div class="col-12S">
                                        <input class="form-control form-control-sm @error('files_link') is-invalid @enderror" type="text"
                                            placeholder="">
                                        @error('files_link')
