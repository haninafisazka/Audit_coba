                ...
                <ul class="list-unstyled ps-0">
                    <li class="mb-1">
                        ...
                        <div class="collapse show" id="home-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="{{route('auditor.dashboard')}}" class="link-dark rounded">Data</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="mb-1">
                        ...
                        <div class="collapse" id="dashboard-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="{{route('auditor.dashboardAuditee')}}" class="link-dark rounded">Data</a>
                                </li>
                    ...
                    <li class="mb-1">
                        ...
                        <div class="collapse" id="orders-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="{{route('auditor.dashboardAuditor')}}" class="link-dark rounded">Data</a>
                                </li>
                    ...
                    <form action="/standarts/{{ $v->id }}/updates" method="post">
                        ...
                        <div class="card p-3 shadow-sm mb-5">
                            ...
                            <div class="d d-inline">
                                    ...
                                    <a href="{{ route('auditor.dashboard') }}"><button type="button" class="btn btn-secondary btn-sm" >Batal</button></a>
                            </div>
                        </div>
                    </form>
                @endforeach
